...
- [noahstoner/Quick-SAAS-Next-app](https://github.com/noahstoner/Quick-SAAS-Next-app) - This is a Next.js 14 project Inventory Management SAAS (Software as a Service) Web App. A Typescript based project using nextjs 14 static-side & server-side rendering. This projects is developed with 
...
- [axios/axios](https://github.com/axios/axios) - Promise based HTTP client for the browser and node.js
- [necordjs/necord](https://github.com/necordjs/necord) - 🤖 A module for creating Discord bots using NestJS, based on Discord.js
- [nyvorin/badwords](https://github.com/nyvorin/badwords) - A javascript filter for badwords
- [TannerGabriel/discord-bot](https://github.com/TannerGabriel/discord-bot) - Simple discord bot to play music and manage your server
- [nickheyer/DiscoFlix](https://github.com/nickheyer/DiscoFlix) - A simple media-requesting, Radarr/Sonarr-interfacing, movie and tv show-listing Chat Bot web-app for your media server.
- [twentyhq/twenty](https://github.com/twentyhq/twenty) - The open alternative to Salesforce, designed for AI.
- [Gapur/js-algorithms](https://github.com/Gapur/js-algorithms) - 🤓 Algorithms and data structures in JavaScript
...
- [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) - Makes your AI agent think like the laziest senior dev in the room. The best code is the code you never wrote.
- [kzndotsh/gang.guide](https://github.com/kzndotsh/gang.guide) - Evidence backed mapping of criminal organizations across the US — alliances, rivalries, history, and culture.
- [alvarofrancomartins/CRIMENET](https://github.com/alvarofrancomartins/CRIMENET) - Open-source knowledge graph of relationships between criminal organizations worldwide, extracted from multi-language Wikipedia with an LLM pipeline.
- [peva3/SmarterRouter](https://github.com/peva3/SmarterRouter) - SmarterRouter: An intelligent LLM gateway and VRAM-aware router for Ollama, llama.cpp, and OpenAI. Features semantic caching, model profiling, and automatic failover for local AI labs.
- [mem0ai/mem0](https://github.com/mem0ai/mem0) - Universal memory layer for AI Agents
- [affaan-m/ECC](https://github.com/affaan-m/ECC) - The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond.
- [bytedance/deer-flow](https://github.com/bytedance/deer-flow) - An open-source long-horizon SuperAgent harness that researches, codes, and creates. With the help of sandboxes, memories, tools, skill, subagents and message gateway, it handles different levels of ta
...
- [idootop/reactflow-auto-layout](https://github.com/idootop/reactflow-auto-layout) - A demonstration of auto-layout capabilities and Figma-like edge editing features built with ReactFlow.
- [better-inbox/better-inbox](https://github.com/better-inbox/better-inbox) - In-app notifications for better-auth apps. One plugin, one migration, one component.
- [C-W-D-Harshit/better-auth-devtools](https://github.com/C-W-D-Harshit/better-auth-devtools) - DevTools for Better Auth to switch users, inspect sessions, and test roles in development.
- [mattpocock/skills](https://github.com/mattpocock/skills) - Skills for Real Engineers. Straight from my .agents directory.
- [paperclipai/paperclip](https://github.com/paperclipai/paperclip) - The open-source app everyone uses to manage agents at work
- [feature-sliced/steiger](https://github.com/feature-sliced/steiger) - Universal file structure and project architecture linter
...
- [tokenring-ai/thinking](https://github.com/tokenring-ai/thinking) - A collection of experimental tools, that get the model to think in various ways.
...
- [Hogjects/Lufus](https://github.com/Hogjects/Lufus) - A modern and easy to use drive imaging and formatting utility inspired from Rufus and written in python for Linux-based systems
...
- [NDGopher/PredictionInsider](https://github.com/NDGopher/PredictionInsider) - Tracking Polymarket’s Top Traders
...
- [tildeclub/site](https://github.com/tildeclub/site) - tilde.club site source
...
- [wobscale/prometheus-irc-exporter](https://github.com/wobscale/prometheus-irc-exporter) - Exports metrics prometheus metrics about an IRC server
...
- [egandro/nginx_proxy_manager_tool](https://github.com/egandro/nginx_proxy_manager_tool) - CLI and Ansible Tool for Nginx Proxy Manager, allowing you to automate configurations by using the REST API.
- [Festeazy/nginxproxymanagerGraf](https://github.com/Festeazy/nginxproxymanagerGraf) - A Python/Shell connector for Nginx Proxy Manager (Docker)
...
- [hermetic-foundation/nix-wrappers](https://github.com/hermetic-foundation/nix-wrappers) - 
...
- [Jamorim-esss/pytest-rich](https://github.com/Jamorim-esss/pytest-rich) - pytest + rich integration (proof of concept)
...
- [phoenixcoded/saasable-ui](https://github.com/phoenixcoded/saasable-ui) - Complete solution for UI pages as well Admin Dashboard
...
- [solaluset/Prima](https://github.com/solaluset/Prima) - A Discord bot
...
- [almighty-loaf/rEFInd-tokyo-night](https://github.com/almighty-loaf/rEFInd-tokyo-night) - Tokyo Night theme for rEFInd
...
- [pridont/i3](https://github.com/pridont/i3) - my i3 config
...
- [yoosefi/plex-scripts](https://github.com/yoosefi/plex-scripts) - Bash/Nemo scripts to organize files for Plex and Jellyfin
...
- [baker-scripts/pmm-config](https://github.com/baker-scripts/pmm-config) - Kometa (Plex Meta Manager) configuration — collection templates, overlays, and metadata management
